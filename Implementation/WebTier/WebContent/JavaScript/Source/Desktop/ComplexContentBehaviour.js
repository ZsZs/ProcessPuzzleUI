...
var ComplexContentBehaviour = new Class({
   ...
   options : {
      ...
      contentUrlSelector : "dc:contentURL",
      disableScrollBars : false,
      disableScrollBarsSelector: "dc:disableScrollBars",
      documentContentUriSelector : "dc:document/dc:documentContentUri",
      documentDefinitionUriSelector : "dc:document/dc:documentDefinitionUri",
      documentNameSeparator : "_",
      documentTypeDefault : AbstractDocument.Types.SMART,
      documentTypeSelector : "dc:document/@type",
      documentWrapperId : "_documentWrapper_" + (new Date().getTime()),
      documentWrapperIdSelector : "dc:document/@id",
      documentWrapperStyle : "documentWrapper",
      documentWrapperStyleSelector : "dc:document/@elementStyle",
      documentWrapperTag : "div",
      documentWrapperTagSelector : "dc:document/@tag",
